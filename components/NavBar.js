...
export default function Navbar(){
    return(
        <div className="px-2 md:px-42 mb-24  align-baseline flow-root mt-5 h-15 text-nav-link absolute w-full  ">
        ...
        {/* {signin/download buttons } */}
             <div className="float-right mt-5 mr-14 inline text-white text-xl 
md:text-shadow-md">
